...
def Net(graph, num_of_neurons):
    data = torch.load("pdadmm_amazon_computers_"+str(num_of_neurons)+"_2layers.pt")
    W1 = data['W1']
    b1 = data['b1']
    z1 = data['z1']
    q1 = data['q1']
...
#
# data = torch.load('pdadmm_amazon_computers_1000_0-99epoch_5layers.pt')
# W1 = data['W1']
# b1 = data['b1']
# z1 = data['z1']
# q1 = data['q1']
...
torch.save(
    {          "W1": W1, "b1": b1, "z1": z1, "q1": q1, "u1": u1,
     ...
     "rho": rho}, \
    'pdadmm_amazon_computers_' + repr(num_of_neurons) + '_5layers.pt')
