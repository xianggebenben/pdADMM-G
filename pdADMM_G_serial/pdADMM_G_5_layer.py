...
def Net(graph, num_of_neurons, seed_num):
    data = torch.load("pdadmm_g_"+dataset_name+"_"+str(num_of_neurons)+"_"+repr(seed_num)+"_2layers.pt")
...
for seed_num in seed_nums:
    ...
    torch.save(
        {"W1": W1, "b1": b1, "z1": z1, "q1": q1, "u1": u1,
         ...
         "rho": rho}, \
        './pdadmm_g_'+dataset_name+'_' + repr(num_of_neurons) +'_'+repr(seed_num)+ '_5layers.pt')
    torch.save(
        ...
        './pdadmm_g_' + dataset_name + '_' + repr(num_of_neurons) + '_' + repr(seed_num) + '_5layers_acc.pt')
